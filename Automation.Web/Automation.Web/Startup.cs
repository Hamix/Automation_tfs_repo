...
using Automation.Web.ViewModels;
using Automation.Web.Helpers;
using Automation.Web.Authorization;
...
namespace Automation.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Automation.Web"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Automation.Web API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Automation.Web API V1");
            });
